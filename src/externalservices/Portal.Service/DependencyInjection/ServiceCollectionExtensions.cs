...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddPortalService(this IServiceCollection services, IConfigurationSection section)
    {
        ...
        var settings = sp.GetRequiredService<IOptions<PortalSettings>>();
        return services
            .AddScoped<IPortalService, PortalService>()
            .AddCustomHttpClientWithAuthentication<PortalService>(settings.Value.BaseAddress);
    }
}
