...
/// <summary>
/// Extension method to register the reissuance service and dependent services
/// </summary>
public static class ReissuanceServiceExtensions
{
    /// <summary>
    /// Adds the reissuance service
    /// </summary>
    ...
    {
        services
            .AddOptions<ReissuanceServiceSettings>()
            .Bind(section)
            .EnvironmentalValidation(section);
        services
            .AddTransient<ReissuanceService>()
