...
Log.Information("Building reissuance worker");
try
{
    var host = Host
        ...
        .ConfigureServices((hostContext, services) =>
        {
            services
                ...
                .AddTransient<IIdentityService, SystemIdentityService>()
                .AddTransient<IIssuerBusinessLogic, IssuerBusinessLogic>()
                .Configure<IssuerSettings>(hostContext.Configuration.GetSection("Credential"))
                .AddHttpClient()
    ...
    Log.Information("Start processing reissuance");
    var workerInstance = host.Services.GetRequiredService<ReissuanceService>();
