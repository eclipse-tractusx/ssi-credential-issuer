...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReissuanceProcess", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_reissuances");

                    b.ToTable("reissuances", "issuer");
                });
            ...
            modelBuilder.Entity("ReissuanceProcess", b =>
                {
                    b.HasOne("Org.Eclipse.TractusX.SsiCredentialIssuer.Entities.Entities.CompanySsiDetail", "CompanySsiDetail")
                        .WithOne("ReissuanceProcess")
                        .HasForeignKey("ReissuanceProcess", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reissuances_company_ssi_details_id");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.SsiCredentialIssuer.Entities.Entities.CompanySsiDetail", b =>
                {
                    ...
                    b.Navigation("ReissuanceProcess");
                });
