...
public class WalletBusinessLogicTests
{
    ...
    public async Task CreateCredential_CallsExpected()
    {
        ...
        var ssiDetail = new CompanySsiDetail(id, null!, VerifiedCredentialTypeId.BUSINESS_PARTNER_NUMBER, CompanySsiDetailStatusId.ACTIVE, Guid.NewGuid(), DateTimeOffset.UtcNow);
