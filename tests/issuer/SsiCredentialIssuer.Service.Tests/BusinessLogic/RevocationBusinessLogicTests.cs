...
public class RevocationBusinessLogicTests
{
    ...
    {
        // Arrange
        var credential = new CompanySsiDetail(CredentialId, "Test", VerifiedCredentialTypeId.BUSINESS_PARTNER_NUMBER, CompanySsiDetailStatusId.ACTIVE, "Test123", Guid.NewGuid(), DateTimeOffset.UtcNow)
        {
