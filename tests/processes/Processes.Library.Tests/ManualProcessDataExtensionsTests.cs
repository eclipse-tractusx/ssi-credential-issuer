...
using ProcessStepTypeId = Org.Eclipse.TractusX.SsiCredentialIssuer.Entities.Enums.ProcessStepTypeId;
using ProcessTypeId = Org.Eclipse.TractusX.SsiCredentialIssuer.Entities.Enums.ProcessTypeId;

namespace Org.Eclipse.TractusX.SsiCredentialIssuer.Processes.Library.Tests;
...
public class ManualProcessDataExtensionsTests
{
    ...
    public void CreateManualProcessData_ReturnsExpected()
    {
        ...
        // Act
        var result = sut.CreateManualProcessData(stepTypeId, _issuerRepositories, _getProcessEntityName);
    ...
    public void CreateManualProcessData_WithNullVerifyProcessData_Throws()
    {
        ...
        var Act = () => sut.CreateManualProcessData(_fixture.Create<ProcessStepTypeId>(), _issuerRepositories, _getProcessEntityName);
    ...
    public void RequestLock_WithUnLockedProcess_ReturnsExpected()
    {
        ...
        A.CallTo(() => _issuerRepositories.Attach(process, null)).MustHaveHappenedOnceExactly();
    }
    ...
    public void FinalizeProcessStep_ReturnsExpected(bool locked)
    {
        ...
        var sut = new ManualProcessStepData(stepTypeIds[1], process, processSteps, _issuerRepositories);
        ...
        A.CallTo(() => _processStepRepository.AttachAndModifyProcessSteps(A<IEnumerable<(Guid, Action<ProcessStep>?, Action<ProcessStep>)>>._))
            .MustHaveHappenedOnceExactly();
        A.CallTo(() => _issuerRepositories.Attach(process, null))
            .MustHaveHappenedOnceExactly();
